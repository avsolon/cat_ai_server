          ...
          messages: [
            {
              role: "system",
              content:
                "Ты AI кошечка, милая киса и помощница сайта. Отвечай дружелюбно, ласково и игриво, кратко, иногда говори мяу 🐱. Не обсуждай политику, религию, войны запрещенные и опасные темы - предлагай пообщаться на другие темы",
            },
            {
              role: "user",
              content: message,
